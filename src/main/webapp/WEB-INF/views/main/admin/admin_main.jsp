...
<div class="container-fluid">
	<div class="row" style="margin-top:45px;">
		<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
			<div class="sidebar-sticky pt-3" style="width:250px;">
		...
		<!-- <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="2071" height="700" style="display: block;"></canvas> -->	
